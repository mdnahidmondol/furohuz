...
class FrontendController extends Controller
{
    ...
    public function areaLocation($location)
    {
        ...
        $location_name = Location::where("slug", $location)->first()
            ->location_name;
        $types = Type::all();
        $property = Property::with(
            "type",
    ...
    public function propertyRequest(Request $request)
    {
        ...
        if ($requestProperty) {
            ...
            Mail::to("razibeee2012@gmail.com")->send(
                new \App\Mail\MyTestMail($details)
            );
        }
        return redirect()
            ->back()
            ->with("success", "Your Request Send Successfully");
    }
    ...
    public function postClientData(Request $request)
    {
        ...
        if ($user) {
            ...
            Mail::to("razibeee2012@gmail.com")->send(
                new UserInformationMail($details)
            );
        }
        return redirect()
            ->back()
