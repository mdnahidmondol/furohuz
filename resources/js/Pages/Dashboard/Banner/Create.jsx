            ...
            <div className="flex items-center px-2 py-3">
              ...
              >
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  {errors && errors.banner_image ? (
                    <div className="text-[red] py-2">{errors.banner_image}</div>
                  ) : null}
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <button className="p-3 bg-green-600 text-white px-10 rounded-lg hover:bg-green-500 ">
                  {" "}
                  Save{" "}
                </button>
              </form>
