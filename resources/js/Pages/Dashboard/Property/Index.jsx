                    ...
                    >
                      ...
                      <td className="pl-5">
                        <div className="flex items-center">
                          ...
                          <p className="text-sm leading-none text-gray-600 ml-2">
                            {item.rating} / {item.recived_count}{" "}
                            <a href="https://api.whatsapp.com/send?phone=01737988947&text=https://furnished.free-blood.com/area/Gulshan/4">
                              d
                            </a>
                          </p>
                        </div>
                      ...
                      <td className="pl-4">
                        <a
                          href={route("property.list.details", item.id)}
