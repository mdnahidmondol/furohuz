                ...
                <ul className="space-y-2 pb-2">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3">Create Type</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                    ...
                    >
                      ...
                      <span className="ml-3">Type List</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="ml-3">Location List</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                    ...
                    >
                      ...
                      <span className="ml-3">Create Property</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                    ...
                    >
                      ...
                      <span className="ml-3">Property List </span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                    ...
                    >
                      ...
                      <span className="ml-3">Banner List</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                      href="/top-header-list"
                      className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group"
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                      ...
                      <span className="ml-3">Top Header List</span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                    ...
                    >
                      ...
                      <span className="ml-3">Feature List </span>
                    </InertiaLink>
                  </li>
                  <li>
                    <InertiaLink
                      href="/request-property-list"
                      className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group"
                    >
                      <svg
                        className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                      ...
                      <span className="ml-3">Request Property </span>
                    </InertiaLink>
                  </li>
                  <li>
                    <button
