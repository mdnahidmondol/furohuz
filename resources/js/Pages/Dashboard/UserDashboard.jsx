    ...
    <>
      <div class="antialiased bg-[#064d83]">
        <header class="lg:px-16 px-6  flex flex-wrap items-center lg:py-0 py-2 w-[80%] mx-auto">
          ...
          <label htmlFor="menu-toggle" class="pointer-cursor lg:hidden block">
            <svg
          ...
          <div
            class="hidden lg:flex lg:items-center lg:w-auto w-full p-6"
            id="menu"
          >
            <nav>
              <ul class="lg:flex items-center justify-between text-base text-white pt-4 lg:pt-0">
                <li>
                  <a
                    class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400 text-xl"
                    href="#"
                  >
                    Home
                  </a>
                ...
                <li>
                  <InertiaLink
                    href="/logout"
                    className="hidden sm:inline-flex ml-5  text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-xl px-5 py-2.5 text-center items-center mr-3"
                  >
      ...
      <div class="flex sm:flex-row flex-col space-y-2 sm:space-x-2 flex-row w-[80%] mx-auto py-16 items-center justify-center ">
        <div class="border-2 flex flex-wrap flex-row sm:flex-col justify-center items-center w-full sm:w-1/4 p-5 bg-white rounded-md shadow-xl border-l-4 border-blue-300">
          <div>
            <div class="font-bold text-5xl">4</div>
            <div class="font-bold text-sm">Total</div>
          </div>
        </div>
        <div class="border-2 flex flex-wrap flex-row sm:flex-col justify-center items-center w-full sm:w-1/4 p-5 bg-white rounded-md shadow-xl border-l-4 border-purple-300">
          <div>
            <div class="font-bold text-5xl text-center">1</div>
            <div class="font-bold text-sm">In Progess</div>
          </div>
        </div>
        <div class="border-2 flex flex-wrap flex-row sm:flex-col justify-center items-center w-full sm:w-1/4 p-5 bg-white rounded-md shadow-xl border-l-4 border-red-300">
          <div>
            <div class="font-bold text-5xl text-center">2</div>
            <div class="font-bold text-sm">Reject</div>
          </div>
        </div>
        <div class=" border-2 flex flex-wrap flex-row sm:flex-col justify-center items-center w-full sm:w-1/4 p-5 bg-white rounded-md shadow-xl border-l-4 border-green-300">
          <div>
            <div class="font-bold text-5xl text-center">1</div>
      ...
      <div class="w-[80%] mx-auto px-4 sm:px-8 shadow-lg my-10 border-2">
        <div class="py-8">
          <div>
            <h2 class="text-2xl font-semibold leading-tight py-4">
              Notifications
            </h2>
          </div>
