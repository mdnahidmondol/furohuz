...
const  Home = ({types, properties, locations, banners, totalCount}) =>{
  return (
   ...
   <section className='py-10 '>
           	<div className=" w-[86%]  md:w-[80%] mx-auto rounded-md" >
		<div className=" mx-auto text-left">
			<div className="grid grid-cols-1 ">
				<div className=" cover w-full py-4 px-6 md:px-5 text-center md:text-left lg:text-left xl:text-left">
					<h1 className="text-xl md:text-2xl font-bold mb-1  text-center text-gray text-[#064d83]">Furnished Apartment Rent in Dhaka</h1>
					<p className=" mb-2 text-gray text-justify">Most of the tenants find it difficult to move their furniture and household items while shifting to a new place. You can get rid of this hassle by renting a furnished apartment. In a big city like Dhaka, it’s not that easy to find an apartment that fulfills all of your requirements. </p>
        ...
        <div className=" cover w-full py-2 px-6 md:px-5 text-center md:text-left lg:text-left xl:text-left">
					<h1 className="text-xl md:text-2xl font-bold mb-2 text-center text-gray text-[#064d83]">What Is A Furnished Apartment?</h1>
					<p className=" mb-3 text-gray text-justify">A furnished apartment comes fully equipped with furniture, appliances, and other amenities. Therefore, you don't have to worry about transporting your own furniture. That will save you time and money. Furnished apartments are the best option for people who are moving to Dhaka temporarily. If you don't want to buy new furniture, a furnished apartment will fulfill your needs.  </p>
        ...
        <div className=" cover w-full pt-3 px-6 md:px-5 text-center md:text-left lg:text-left xl:text-left">
					<h1 className="text-xl md:text-2xl font-bold mb-1 text-center text-gray text-[#064d83]">Special Facilities of Furnished Apartment Rent in Dhaka</h1>
					<p className=" mb-5 text-gray text-justify">Renting a furnished apartment will be ideal both for short-term and long-term rentals. Here are some special facilities that you can expect to have in a furnished apartment.</p>
				</div>
      ...
      >
        <SwiperSlide><div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Furniture</a>
        <p className="text-sm text-black text-justify">This is the most obvious feature of a furnished apartment. From the living room to the bedroom, you'll find everything you need to live comfortably. This includes sofas, chairs, tables, beds, dressers, and more. Are you thinking about the quality of that furniture? Well, those types of furniture are usually high-quality, functional, and stylish.</p>
       
      </div></SwiperSlide>
        <SwiperSlide>
        <div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Appliances</a>
        <p className="text-sm text-black text-justify">Fully Furnished apartments come with a wide range of home appliances. It includes a refrigerator, stove, microwave, dishwasher, washer, and dryer. Having these appliances in your newly rented house will save you a decent amount of money. There is no hassle to buy them yourself.</p>
       
      </div>
        </SwiperSlide>
        <SwiperSlide><div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Utilities</a>
        <p className="text-sm text-black text-justify">In a furnished apartment, most of the utility bills are included with the rent. Therefore, you don’t have to worry about paying separate bills for electricity, water, gas, or internet. However, you should check the lease to see which bills are included along with the rental cost. </p>
       
      </div></SwiperSlide>
        <SwiperSlide><div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Maid Service</a>
        <p className="text-sm text-black text-justify">Some furnished apartments offer maid services. It offers tenants regular cleaning of the apartment, changing linens, and restocking supplies. It will be a great way to keep your living space tidy. Point to be noted that you may not get this facility as all furnished apartments</p>
       
      </div></SwiperSlide>
        <SwiperSlide><div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Security</a>
        <p className="text-sm text-black text-justify">While looking for a new apartment, most tenants are conscious of security. Furnished apartments always offer proper security features to keep you safe. You are going to get secure entrances, surveillance cameras, and alarms. Moreover, many furnished apartment buildings have security staff on-site to monitor the property.</p>
       
      </div></SwiperSlide>
        <SwiperSlide><div className="p-14">
        
        <a className="text-md font-bold sm:text-md md:text-md">Parking</a>
        <p className="text-sm text-black text-justify">Do you have a car? Well, you are going to get car parking facilities. In a furnished apartment, you will get an assigned parking spot in a garage. This facility will give you peace of mind. Also, it will save you from the hassle of searching for parking on the street.</p>
       
      </div></SwiperSlide>
       
        
      </Swiper>
      <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-4">
      <div className="flex flex-col items-start col-span-12 space-y-1 sm:col-span-6 xl:col-span-4 hidden md:block">
...
Is there still any doubt left in your mind about why you should rent a furnished apartment in Dhaka? If you have any rental queries, feel free to contact us. Our support team will assist you to make the best decision. However, you might be thinking about the location. Let me inform you of 3 prime locations that you can choose according to your convenience. </p>
    ...
    <div className=" w-full py-1 px-2 md:px-2 text-center md:text-left lg:text-left xl:text-left mt-1">
					<h1 className="text-xl md:text-2xl text-center font-bold mb-2 text-gray text-[#064d83]">Prime Location to Rent Furnished Apartment in Dhaka</h1>
					<p className=" mb-3 text-gray">Fully Furnished apartments are often located in desirable areas. It will be convenient for tourists and foreigners to explore new surroundings. Here’s the list of the 3 most attractive places to rent an apartment in Dhaka city. </p>
				</div>

        <div className="grid grid-cols-12  gap-x-8 gap-y-2">
      
      <div className="flex flex-col items-start col-span-12 space-y-1 sm:col-span-6 xl:col-span-4 shadow-lg p-5 rounded-lg">
        
        <a className="text-lg font-bold sm:text-md md:text-md text-[#064d83]">Furnished Apartment for Rent in Gulshan </a>
        <p className="text-sm text-black text-justify">Gulshan is the most luxurious place to choose when looking for a place to stay in Dhaka. Roads, buildings, and infrastructures are highly developed here. It’s a highly secure place. 29 resident embassies are located in Gulshan. If you are working in an embassy, Gulshan will be the most suitable place for you. Recreation facilities are also available here. Parks and clubs are available to make your leisure moment enjoyable. </p>
       
      </div>
      <div className="flex flex-col items-start col-span-12 space-y-1 sm:col-span-6 xl:col-span-4 shadow-lg p-5 rounded-lg">
        
        <a className="text-lg font-bold sm:text-md md:text-md text-[#064d83]">Furnished Apartment for Rent in Banani </a>
        <p className="text-sm text-black text-justify">Are you looking for a luxurious apartment rent in Dhaka at a comparably lower price than in Gulshan? Banani will be the ideal option for you. You can get all the facilities of living in an elite area. It’s connected with Gulshan. It’s only a matter of a short time to move from Banani to Gulshan. Proper security, planned roads, and convenient transportation have made Banani a demandable place for the tenant. </p>
       
      </div>
      <div className="flex flex-col items-start col-span-12 space-y-1 sm:col-span-6 xl:col-span-4 shadow-lg p-5 rounded-lg">
        
        <a className="text-lg font-bold sm:text-md md:text-md text-[#064d83]">Furnished Apartment for Rent in Baridhara Diplomatic Zone</a>
        <p className="text-sm text-black text-justify">Being a dedicated diplomatic zone, Baridhara is the most secure place to live in Dhaka. If you want to stay in a secure environment, you can choose this place without any hesitation. Moreover, the area is totally free from noise and vehicle horns. The green zone has made it a sustainable area. Parks and clubs are available for recreation. Overall, you can fulfill all of your expectations. It will be best for tourists and foreigners. <br></br><br></br>
    ...
    <div className=" w-full py-6 px-2 md:px-2 text-center md:text-left lg:text-left xl:text-left mt-2">
          ...
          <p className="text-sm text-black text-justify">At this stage, you should have got in-depth knowledge about Furnished Apartment Rent in Dhaka. Now, you know whether you should rent a furnished apartment or not. You can have a look at our rental listings to get the best apartments in your desired area. If you want to rent an apartment, contact our team to get rental assistance. It will be a win-win situation both for tenants and owners. Good luck to you!
           </p>
				</div>
...
{/* 
	...
	<div className="flex flex-col items-center">
		<h2 className="font-bold text-3xl mt-10 tracking-tight text-[#064d83]">
			FAQ
		</h2>
