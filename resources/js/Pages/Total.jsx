...
const Total = () => {
    ...
    return (
        <>
            <header className="" >
      <nav className={` fixed md:fixed  z-10 w-full bg-red  dark:bg-transparent   ${url == '/' ? 'bg-white md:bg-transparent':' '}`}>
            ...
            <div className="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
                ...
                <div className="w-full px-6 flex justify-between lg:w-max md:px-0 z-30">
                   <div><InertiaLink href="/" aria-label="logo" className="flex space-x-2 items-center">
                        <img src="/logo/logo.jpeg" className="w-16 md:w-32 mt-2" alt="tailus logo" width="144" height="133"/>
                    </InertiaLink>
                    </div> 
                    <div class="pt-0 relative mx-auto text-gray-600 md:hidden ">
        <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none w-48"
          type="search" name="search" placeholder="Search"/>
        <button type="submit" class="absolute right-0 top-0 mt-0 mr-0.5 bg-[#064d83] rounded p-2.5">
                ...
                <div className="hidden peer-checked:flex w-full flex-col lg:flex lg:flex-row justify-end z-30 items-center gap-y-6 p-6 rounded-xl bg-white dark:bg-gray-900 lg:gap-y-0 lg:p-0 md:flex-nowrap lg:bg-transparent lg:w-7/12">
                    <div className="text-gray-600 lg:pr-4 w-full">
                        ...
                        flex flex-col gap-y-6 lg:gap-y-0 lg:flex-row w-full">
                            <li>
                                <InertiaLink href="/" className={`block md:px-4  ${url == '/' ? 'md:text-white ':''} transition dark:text-gray-300 dark:hover:text-yellow-300 hover:text-white-700`}>
                                    <span>APARTMENTS</span>
                                </InertiaLink>
                            </li>
                            <li>
                                <InertiaLink href="/property" className={`block md:px-4 ${url == '/' ? 'md:text-white ':''} transition dark:text-gray-300 dark:hover:text-yellow-300 hover:text-white-700`}>
                                    <span>PROPERTY OWNER</span>
                                </InertiaLink>
                            </li>
                            <li>
                                <a href="/about" className={`block md:px-4 transition  ${url == '/' ? 'md:text-white ':''} dark:text-gray-300 dark:hover:text-yellow-300 hover:text-white-700`}>
                                    <span>ABOUT</span>
                                </a>
                            </li>
                            <li>
                                <a href="/contact" className={`block md:px-4  ${url == '/' ? 'md:text-white ':''} transition dark:text-gray-300 dark:hover:text-yellow-300 hover:text-white-700`}>
                                    <span>CONTACT</span>
                                </a>
                            </li>
                            <li>
                                <a href="/" className={`block md:px-4 transition ${url == '/' ? 'md:text-white ':''} dark:text-gray-300 dark:hover:text-yellow-300 hover:text-white-700`}>
                                    <span>CORPORATE</span>
                                </a>
                            </li>
                        </ul>
                   ...
                   lg:space-y-0 sm:w-max  dark:lg:border-gray-700 mx-2">
                        ...
                        <button type="button" title="Start buying" className="w-full py-3 px-6 text-center rounded-full transition bg-[#064d83]  active:bg-[#064d83] focus:bg-[#064d83] sm:w-max">
...
<div className="relative  bg-gray-800 h-screen" style={{backgroundImage:`url('/image/hero.jpg')`}}>
        <div className=" m-auto px-2 pt-40 md:pt-52 md:px-12 lg:pt-[4.8rem] lg:px-7 bg-gray-800 bg-opacity-50 h-screen ">
            <div className="flex flex-col md:flex-row  items-center  text-center px-6 md:px-52 w-[100%] md:w-[75%] m-auto">
                <div className="relative  lg:w-full  lg:py-48 xl:py-72 pt-10">
                    <h1 className="font-bold text-3xl text-white  md:text-4xl ">Your furnished apartment ready to move in</h1>
                    <p className="mt-4 text-md text-white dark:text-white-200 ">Beautifully designed, fully furnished apartments in São Paulo, Rio de Janeiro and Brasília to make you feel at home</p>
                            ...
                            <div id="categories" className=" p-1 rounded-full bg-transparent w-70 md:w-80 relative md:p-4 md:flex justify-between items-center select-none">
                                ...
                                <div id="categorieLst" className="absolute transition-all duration-500 ease-in-out translate-y-10 opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-y-1 top-full left-0 w-full bg-white border border-yellow-200 shadow-md rounded-lg py-2">
                                    <ul className="flex flex-col w-full">
                                        <li className="cursor-pointer transition hover:bg-gray-100 hover:bg-opacity-80 flex px-5 py-2">Gulshan</li>
                                        <li className="cursor-pointer transition hover:bg-gray-100 hover:bg-opacity-80 flex px-5 py-2">Baridahara</li>
                                        <li className="cursor-pointer transition hover:bg-gray-100 hover:bg-opacity-80 flex px-5 py-2">Banani</li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div>
        <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, aspernatur obcaecati in qui aperiam nemo quis aut fuga nam ad delectus, quos officia excepturi, enim reiciendis maiores quo iure nihil? Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestiae itaque dolores numquam inventore accusamus, neque similique provident voluptatum sunt iure qui est voluptatem labore animi fugiat ullam libero consequuntur enim? Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nesciunt corporis, temporibus similique hic optio cum, sequi quis illo laborum assumenda dignissimos aliquid nemo laudantium repudiandae dolorem ut. Dolorem, laudantium?
        </p>
        <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis, aspernatur obcaecati in qui aperiam nemo quis aut fuga nam ad delectus, quos officia excepturi, enim reiciendis maiores quo iure nihil? Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestiae itaque dolores numquam inventore accusamus, neque similique provident voluptatum sunt iure qui est voluptatem labore animi fugiat ullam libero consequuntur enim? Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nesciunt corporis, temporibus similique hic optio cum, sequi quis illo laborum assumenda dignissimos aliquid nemo laudantium repudiandae dolorem ut. Dolorem, laudantium?
        </p>
